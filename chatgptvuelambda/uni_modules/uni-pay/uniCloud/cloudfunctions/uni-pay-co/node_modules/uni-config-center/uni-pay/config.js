...
module.exports = {
	...
	"notifyUrl": {
		// 本地开发环境-支付回调地址
		"tcb-3z2di3tbwemafha-1ch7dd6caa2e": "https://tcb-3z2di3tbwemafha-1ch7dd6caa2e.service.tcloudbase.com/uni-pay-co",
		// 线上正式环境-支付回调地址
		"tcb-3z2di3tbwemafha-1ch7dd6caa2e": "https://tcb-3z2di3tbwemafha-1ch7dd6caa2e.service.tcloudbase.com/uni-pay-co",
	},
	...
	"wxpay": {
		...
		// 微信 - 小程序支付
		"mp": {
			"appId": "wx128915bb112e936a", // 小程序的appid
			"secret": "4920b1583fb4891ff85ba699063593b5", // 小程序的secret
			"mchId": "1603352710", // 商户id
			"key": "ZWmgVktuAtuuO13HXEcPFGTI913FtDWv", // v2的api key
		...
		// 微信 - APP支付
		"app": {
			"appId": "wx333f6563034a5b8c", // app开放平台下的应用的appid
			"secret": "d448630817047b0950218301ac2d0e08", // app开放平台下的应用的secret
			"mchId": "1639030197", // 商户id
			"key": "S6EXPOtRErqAwkcUaqF6U53EF0N5ipP3", // v2的api key
			"pfx": fs.readFileSync(__dirname + '/wxpay/apiclient_cert.p12'), // v2需要用到的证书
			"v3Key": "", // v3的api key
			"appCertPath": path.join(__dirname, 'wxpay/apiclient_cert.pem'), // v3需要用到的证书
			"appPrivateKeyPath": path.join(__dirname, 'wxpay/apiclient_key.pem'), // v3需要用到的证书
		...
		// 微信 - 扫码支付
		"native": {
			"appId": "wx128915bb112e936a", // 可以是小程序或公众号或app开放平台下的应用的任意一个appid
			"secret": "4920b1583fb4891ff85ba699063593b5", // secret
			"mchId": "1603352710", // 商户id
			"key": "ZWmgVktuAtuuO13HXEcPFGTI913FtDWv", // v2的api key
			"pfx": fs.readFileSync(__dirname + '/wxpay/apiclient_cert.p12'), // v2需要用到的证书
			"v3Key": "", // v3的api key
