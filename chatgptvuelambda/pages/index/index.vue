<template>
	<view class="index">
        ...
        display: currentTabbarIndex === 4 ? '' : 'none'
			...
			<scroll-view class="custom-tabbar-page" scroll-y enable-back-to-top @scrolltolower="tabbarPageScrollLower">
				<page-e ref="pageE" :number="number"></page-e>
			</scroll-view>
		</view>
		...
		<view class="tabbar">
			...
			<view class="action" @tap.stop="changeTabbar(0)">
				<view class="bar-icon">
					...
					<image class="" :src="`/static/tabbar/home_tn${currentTabbarIndex === 0 ? 'new' : ''}.png`"></image>
				</view>
			...
			<view class="action" @tap.stop="changeTabbar(4)">
				<view class="bar-icon">
					...
					<image class="" :src="`/static/tabbar/mine_tn${currentTabbarIndex === 4 ? 'new' : ''}.png`"></image>
				</view>
