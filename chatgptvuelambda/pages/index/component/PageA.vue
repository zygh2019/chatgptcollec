<template>
	<view class="basic tn-safe-area-inset-bottom" style="padding-top: 400rpx;position: relative;">
		<view style="position: absolute;width: 100%;height: 800rpx;top: 0;z-index: 0;" @click="aaa">
			<view class="wrapper">
				<view class="candles">
...
<script>
	...
	export default {
		...
		methods: {
			aaa() {
				uni.request({
					url: 'http://104.168.141.167:3000/chat',
					method: 'post',
